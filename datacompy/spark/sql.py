...
def _is_comparable(type1: str, type2: str) -> bool:
    ...
    if type1 in NUMERIC_SPARK_TYPES and type2 in NUMERIC_SPARK_TYPES:
        return True

    if (type1 == "string" and type2 in ("timestamp", "date")) or (
        type2 == "string" and type1 in ("timestamp", "date")
    ):
        return True
